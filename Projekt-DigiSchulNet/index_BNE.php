...
<html lang="de">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
	    <title>Erhebung DigiSchulNet</title>
...
//removes nodes and links and refreshes	with a single start-node ("Sie")	  
	...
	resetGraph();
      ...
      if (isIE()) {
		...
		slide_0.append("text")
          ...
          .text("Ziel des Vorhabens ist die Analyse des Transfers von Wissen, Praxisbeispielen und Handlungsstrategien innerhalb bestehender Schulnetzwerke und in die beteiligten Schulen hinein. Dafür werden Schulnetzwerke in den Blick genommen, die verschiedene innovative Themen verfolgen: Solche mit Schwerpunkt im Bereich der Bildung für nachhaltige Entwicklung sowie Schulnetzwerke mit Schwerpunkt Bildung in der digitalen Welt. Hier sollen vor allem die Kommunikationsbeziehungen innerhalb der Schulnetzwerke sowie die Weitergabe des dort erworbenen Wissens in die Einzelschule untersucht werden.")
		  .call(wrap, textWidth);
		slide_0.append("text")
          .attr("class", "slideText")
          .attr("x", center - textWidth / 2)
          .attr("y", lineHeight + lineHeight * 15)
		...
		slide_0.append("text")
          .attr("class", "slideText")
          .attr("x", center - textWidth / 2)
          .attr("y", title_offset_top + lineHeight * 18)
          .text("Bitte geben Sie Ihren persönlichen Zugriffscode in das Kästchen unten ein und klicken Sie Bestätigen. Wir danken Ihnen nochmals herzlich für Ihre Mitwirkung und Ihr Vertrauen in unsere Arbeit. ")
		  .call(wrap, textWidth);
		slide_0.append("text")
          .attr("class", "slideText")
          .attr("x", center - textWidth / 2)
		...
		slide_0.append("text")
          .attr("class", "slideText")
          .attr("x", center - textWidth / 2)
          .attr("y", title_offset_top + lineHeight * 23)
	  ...
	  slide_1.append("text")
        ...
        .text("Im Folgenden werden Ihnen einige Fragen dazu gestellt, von welchen Personen an Ihrer Schule oder aus dem BNE-Netzwerk Sie in den letzten drei Monaten Informationen zum Thema Bildung für nachhaltige Entwicklung (BNE) ")
		.attr("class", "slideText")
		.call(wrap, textWidth);
	  slide_1.append("text")
		.attr("class", "underlinedSlideText")
		.text("erhalten")
		.attr("x", center - textWidth / 2.25 +5)
        .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)
		.call(wrap, textWidth);
	  slide_1.append("text")
		.attr("class", "slideText")
		.text("haben.")
        .attr("x", center - textWidth / 2.7 +8)
        .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)
		.call(wrap, textWidth);
	  slide_1.style("display", "none");
		
      // Slide 3       
	//slide with name input field
      ...
      slide_3.append("text")
        ...
        .text("Wenn Sie an die letzten drei Monate denken, von welchen Personen haben Sie Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema BNE ")
        .call(wrap, textWidth);
      slide_3.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + textWidth/7 + 12)
      ...
      slide_3.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top + lineHeight * ($('#slide3 .slideText tspan').length + $('#slide3 .slideText').length-1) +($('#slide3 .slideText tspan').length + $('#slide3 .slideText').length-1))
		.text("Bitte geben Sie keine vollständigen Namen an. Nutzen Sie stattdessen nur die ersten beiden Buchstaben des Vor- und Nachnamens (Bsp.: Erika Musterfrau = ErMu). Nehmen Sie ggf. die Liste der Teilnehmer*innen des letzten Netzwerktreffens zur Hilfe. Sie können bis zu 5 Personen angeben. Wenn Sie zu dieser Frage keine Personen angeben möchten, klicken Sie bitte einfach 'Weiter'.")
        .call(wrap, textWidth);
      ...
      slide_3.append("text")
        ...
        .style("stroke", "none")
        .style("fill", "red")
        .text("Gibt es weitere Personen, mit denen Sie sich zum Thema BNE ausgetauscht haben? Bitte geben Sie die Abkürzung der Namen ein.")
        .call(wrap, textWidth)
        .attr("display", "none");
      slide_3.append("text")
        .attr("class", "slideText")
      ...
      slide_6.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wie oft haben Sie mit den genannten Personen in den letzten drei Monaten über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zur BNE gesprochen?")
        .call(wrap, textWidth);
      slide_6.append("text")
        .attr("class", "slideText") //numfri2
        .attr("x", center - (textWidth / 2))
    ...
    var slide_12 = d3.select("svg").append("g")
      ...
      slide_12.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Soweit Sie wissen: Welche der von Ihnen genannten Personen tauschen sich auch untereinander über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema Bildung für nachhaltige Entwicklung aus?") 
        .call(wrap, textWidth);
      slide_12.append("text")
        .attr("class", "slideText")
        .attr("x", center - (textWidth / 2))
	  ...
	  slide_14.append("text")
          ...
          .attr("x", center - textWidth / 2)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 4-50)
          .text("Im Folgenden werden Ihnen nun einige Fragen dazu gestellt, an welche Personen an Ihrer Schule oder aus dem BNE-Netzwerk Sie selbst in den letzten drei Monaten Informationen zum Thema Bildung für nachhaltige Entwicklung (BNE) ")
          .call(wrap, textWidth);
	  slide_14.append("text")
		.attr("class", "underlinedSlideText")
		.text("weitergegeben")
		.attr("x", center - textWidth / 3 +4)
        .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)
		.call(wrap, textWidth);
	  slide_14.append("text")
		.attr("class", "slideText")
		.text("haben.")
		.attr("x", center - textWidth / 5 +6)
        .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)
		.call(wrap, textWidth);		
	  slide_14.append("text")
          .attr("class", "slideText")
	...
	var slide_15 = d3.select("svg").append("g")
      ...
      slide_15.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, an wen haben Sie Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema BNE ")
        .call(wrap, textWidth);
      slide_15.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + textWidth/8-50)
        .attr("y", text_offset_top + lineHeight)
        .text("weitergegeben?")
        .call(wrap, textWidth);		
      slide_15.append("text")
      ...
      slide_15.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top + lineHeight * ($('#slide15 .slideText tspan').length + $('#slide15 .slideText').length-1) +($('#slide15 .slideText tspan').length + $('#slide15 .slideText').length-1))
		.text("Bitte geben Sie keine vollständigen Namen an. Nutzen Sie stattdessen nur die ersten beiden Buchstaben des Vor- und Nachnamens (Bsp.: Erika Musterfrau = ErMu). Nehmen Sie ggf. die Liste der Teilnehmer*innen des letzten Netzwerktreffens oder ähnliches zur Hilfe. Sie können bis zu 5 Personen angeben. Wenn Sie zu dieser Frage keine Personen angeben möchten, klicken Sie bitte einfach 'Weiter'.")
        .call(wrap, textWidth);
      ...
      slide_15.append("text")
        ...
        .style("stroke", "none")
        .style("fill", "red")
        .text("Gibt es weitere Personen, denen Sie Informationen zum Thema BNE weitergegeben haben? Bitte geben Sie die Abkürzung der Namen ein. Falls nicht zutreffend, klicken Sie bitte weiter.")
        .call(wrap, textWidth)
        .attr("display", "none");
      slide_15.append("text")
        .attr("class", "slideText")
	...
	var slide_33 = d3.select("svg").append("g")
	 ...
	 slide_33.append("rect")
	  ...
	  slide_33.append("text")
          ...
          .attr("x", center - textWidth / 2)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 4-50)
          .text("Im Folgenden werden Ihnen nun einige Fragen dazu gestellt, mit welchen Personen an Ihrer Schule oder aus dem BNE-Netzwerk Sie in den letzten drei Monaten arbeitsteilig an Strategien oder Maßnahmen zur Bildung für nachhaltige Entwicklung (BNE) ")
          .call(wrap, textWidth);
	  slide_33.append("text")
          .attr("class", "underlinedSlideText")
          .attr("x", center - textWidth / 4 +25)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50 )
          .text("zusammengearbeitet ")
          .call(wrap, textWidth);
	  slide_33.append("text")
          .attr("class", "slideText")
          .attr("x", center - textWidth / 17 +25)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)
          .text("haben.")
          .call(wrap, textWidth);		  
	  slide_33.append("text")
	...
	var slide_34 = d3.select("svg").append("g")
      ...
      slide_34.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, mit welchen Personen haben Sie arbeitsteilig an bestehenden oder neuen Strategien oder Maßnahmen zur BNE ")
        .call(wrap, textWidth);
      slide_34.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + (textWidth / 7) - 192)
        .attr("y", text_offset_top + lineHeight)
        .text("zusammengearbeitet?")
        .call(wrap, textWidth);
      slide_34.append("text")
        ...
        .text("Damit ist beispielsweise gemeint, dass Sie arbeitsteilig mit Personen dokumentiert haben, welche Fähigkeiten in Bezug auf Bildung für nachhaltige Entwicklung Schüler*innen im jeweiligen Unterricht vermittelt wurden oder Sie mit Personen Absprachen darüber getroffen haben, unter welchen Rahmenbedingungen und mit welchen Mitteln Nachhaltigkeit bei der Bewirtschaftung der Schule eingelöst werden kann. Die Zusammenarbeit kann sich dementsprechend auf Fragen der Unterrichtsentwicklung, Fortbildungsangebote oder auch organisatorischer Rahmenbedingungen beziehen und sowohl Personen an Ihrer eigenen Schule  (auch Schüler- sowie Elternvertreter*innen) als auch Personen an anderen Schulen bzw. Organisationen im BNE-Netzwerk umfassen. ")
        .call(wrap, textWidth);
	  slide_34.append("text")
		.attr("class", "boldSlideText")
      ...
      slide_34.append("text")
        ...
        .style("stroke", "none")
        .style("fill", "red")
        .text("Gibt es weitere Personen, mit denen Sie arbeitsteilig an Strategien und Maßnahmen zur BNE an der Schule zusammengearbeitet haben? Bitte geben Sie die Abkürzung der Namen ein. Falls nicht zutreffend, klicken Sie bitte weiter.")
        .call(wrap, textWidth)
        .attr("display", "none");
      slide_34.append("text")
        .attr("class", "slideText")
	...
	var slide_37 = d3.select("svg").append("g")
      ...
      slide_37.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wie oft haben Sie mit den genannten Personen in den letzten drei Monaten arbeitsteilig an bestehenden oder neuen Praxisbeispielen, Maßnahmen oder Strategien zur BNE zusammengearbeitet?")
        .call(wrap, textWidth);
      slide_37.append("text")
        .attr("class", "slideText")//numfri2
        .attr("x", center - (textWidth / 2))
	...
	var slide_50 = d3.select("svg").append("g")
      ...
      slide_50.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Soweit Sie wissen: Welche der von Ihnen genannten Personen haben auch untereinander arbeitsteilig an bestehenden oder neuen Strategien oder Maßnahmen zum Thema Bildung für nachhaltige Entwicklung zusammengearbeitet?") 
        .call(wrap, textWidth);
      slide_50.append("text")
        .attr("class", "slideText")
        .attr("x", center - (textWidth / 2))
	 ...
	 slide_52.append("rect")
	  ...
	  slide_52.append("text")
          ...
          .text("Im Folgenden werden Ihnen nun einige Fragen dazu gestellt, mit welchen Personen an Ihrer Schule oder aus dem BNE-Netzwerk Sie sich in den letzten drei Monaten getroffen haben (auch virtuell/digital unterstützt oder telefonisch), um gemeinsam systematisch Strategien oder Maßnahmen zum Thema Bildung für nachhaltige Entwicklung zu ")
          .call(wrap, textWidth);	  
	  slide_52.append("text")
          .attr("class", "underlinedSlideText")
          .attr("x", center - textWidth / 2 +110)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 6-50)//*4
          .text("entwickeln.")
          .call(wrap, textWidth);		  
	  slide_52.append("text")
          .attr("class", "slideText")
      ...
      slide_53.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, mit welchen Personen haben Sie sich getroffen, um gemeinsam systematisch Strategien oder Maßnahmen zum Thema BNE zu ")
        .call(wrap, textWidth);
      slide_53.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + (textWidth / 8)- 45)
        .attr("y", text_offset_top + lineHeight)
        .text("entwickeln?")
        .call(wrap, textWidth);		
      slide_53.append("text")
        ...
        .text("Damit ist beispielsweise gemeint, dass Sie sich mit Personen getroffen haben, um systematisch Unterrichtsstunden zum Thema Bildung für nachhaltige Entwicklung zu entwickeln, gegenseitige Unterrichtshospitationen mit einer Person durchgeführt haben oder sich mit Personen getroffen haben, um systematisch Nachhaltigkeit in der Bewirtschaftung der Schule weiterzuentwickeln. ")
        .call(wrap, textWidth);
      slide_53.append("text")
        .attr("class", "slideText")
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top + lineHeight * ($('#slide53 .slideText tspan').length + $('#slide53 .slideText').length-1))
        .text("Die gemeinsame Entwicklung kann sich dementsprechend auf Fragen der Unterrichtsentwicklung, Fortbildungsangebote oder auch organisatorischer Rahmenbedingungen beziehen und sowohl Personen an Ihrer eigenen Schule (auch Schüler- sowie Elternvertreter*innen) als auch Personen an anderen Schulen bzw. Organisationen im BNE-Netzwerk umfassen.")
        .call(wrap, textWidth);
	  slide_53.append("text")
		.attr("class", "boldSlideText")
      ...
      slide_53.append("text")
        ...
        .style("stroke", "none")
        .style("fill", "red")
        .text("Gibt es weitere Personen, mit denen Sie sich getroffen haben, um gemeinsam Strategien oder Maßnahmen zur BNE zu entwickeln? Bitte geben Sie die Abkürzung der Namen ein. Falls nicht zutreffend, klicken Sie bitte weiter.")
        .call(wrap, textWidth)
        .attr("display", "none");
      slide_53.append("text")
        .attr("class", "slideText")
	 ...
	 var slide_57 = d3.select("svg").append("g")
      ...
      slide_57.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wie oft haben Sie mit den genannten Personen in den letzten drei Monaten gemeinsam, systematisch Maßnahmen oder Strategien zur BNE entwickelt?")
        .call(wrap, textWidth);
      slide_57.append("text")
        .attr("class", "slideText")//numfri2
        .attr("x", center - (textWidth / 2))
	 ...
	 var slide_69 = d3.select("svg").append("g")
      ...
      slide_69.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Soweit Sie wissen: Welche der von Ihnen genannten Personen haben sich auch untereinander getroffen, um gemeinsam systematisch Strategien und Maßnahmen zum Thema BNE an der Schule zu entwickeln?") 
        .call(wrap, textWidth);
      slide_69.append("text")
        .attr("class", "slideText")
        .attr("x", center - (textWidth / 2))
...
//labels and texts for tenBar 1
   var eightLabelBar1 = d3.select("svg").append("g")
      ...
      eightLabelBar1.append("text")
        .attr("class", "bar_text")
        .text("Ministerien")
		.attr("x", boxbar_offset_x + (bar6_target_width / 2) - 45) //bar6_target_width + boxbar_margin + 
        .attr("y", boxbar_offset_y - boxbar_label_margin - 17);
      ...
      eightLabelBar1.append("text")
        .attr("class", "bar_text")
        .text("Universität")
		.attr("x", boxbar_offset_x + (bar6_target_width + boxbar_margin) * 3 + (bar6_target_width / 2)-50)
	  ...
	  eightLabelBar1.append("rect")
        .attr("class", "bar_label")
        .attr("id", "außerschulische_bildungsanbieter")     
        .attr("rx", 4)
        .attr("ry", 4)
		.attr("x", boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2)
        .attr("y", boxbar_offset_y - bar_label_height - boxbar_label_margin)
      ...
      eightLabelBar1.append("text")
        .attr("class", "bar_text")
		.text("Außerschulische")
		.attr("x", boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2 + (bar6_target_width / 2)-60)
        .attr("y", boxbar_offset_y - boxbar_label_margin - 20);
		//append text for second line
	  eightLabelBar1.append("text")
        .attr("class", "bar_text")
		.text("Bildungsanbieter")
		.attr("x", boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2 + (bar6_target_width / 2)-60)
        .attr("y", boxbar_offset_y - boxbar_label_margin - 5);
      ...
      function addFriend() {
        ...
        if (friendName.value.length > 4 || friendName.value.indexOf(' ') != -1|| friendName.value.search(/^[a-zA-ZüÜöÖäÄß ]+$/)== -1) {
          promptOnlyOne();
	...
	function skipQuestions() {
      ...
      function promptFalseID() {
        document.getElementById("falseID_box").style.display = "block";
        document.getElementById("falseIdPopup").style.display = "block";
      }	  
	  ...
	  function closeFalseIDPopup() {
        document.getElementById("falseID_box").style.display = "none";
        document.getElementById("falseIdPopup").style.display = "none";
      }	  
	  ...
	  function saveValue() {
		 ...
		 if (teilnehmercodeInput.value===null || teilnehmercodeInput.value===""){
			promptNoId();
			 ...
			 if (teilnehmercodeInput.value.length != 15){
				 promptFalseID();
...
//---------------------------1. Part-------------------------------------------------------	
		  ...
		  document.getElementById("one_at_a_time").style.display = "block";
		  document.getElementById("erläuterungen").style.display = "block";
...
//	Slides with tenBar
          ...
          setTimeout(function() {
            ...
            d3.selectAll(".node").attr("opacity", function(d) { return d.index == 0 ? 0 : 1 }); //d3.selectAll(".node").attr("opacity", function(d) { return d.index == 0 ? .4 : 1 });
          },1000); 
		  ...
		  nodes.forEach(function(n) {
			...
			//actual statement for ten Boxes   
              if ((n.x < (boxbar_offset_x + (bar6_target_width + boxbar_margin) * 5) && n.y <(boxbar_offset_y - 450)) || ((n.x > boxbar_offset_x + bar6_target_width) && (n.y < boxbar_offset_y))){
                nodeAbove = true;
                console.log("nodeAbove: " + nodeAbove);
              }
          ...
          if ((nodeBelow || nodeAbove) && !checked) {
            ...
            nodes.forEach(function(n) {
			  //Collect Data
			  if (n.index > 0) {
				if (n.x < boxbar_offset_x + bar6_target_width && n.y < (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*2) && n.y > (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*3)) {
...
//	Slides with sixBar
         ...
         document.getElementById("slide4").style.display = "none";
          ...
          setTimeout(function() {
            d3.selectAll(".node").classed("fixed", function(d) { d.fixed = true});
            d3.selectAll(".link").attr("display", "none");  
            d3.selectAll(".node").attr("opacity", function(d) { return d.index == 0 ? 0 : 1 });
          },1000);
...
//----------------------actual version-----------------------------------------------
		...
		if ($('input[name=artDerKommunikation]:checked').length == 0 && !checked && !skipped) {
			...
			askedAbout = 0;				//set 0 to use skip function
			askedAbout++;
			d3.selectAll(".node").attr("opacity", function(d) { return d.index == askedAbout ? 1 : .4 });
			currNode = nodes[askedAbout];
...
// If user has not selected an option, alert with popup
		...
		if ((erhInfoInput.value === null || erhInfoInput.value === "") && !checked && !skipped) {
			...
			d3.select("svg").append("text")
			  ...
			  .attr("x", currNode.x - q_window_width / 2 - 100)
			  .attr("dy", currNode.y - 202)
			  .text("Wir würden gerne mehr über ihren Austausch mit '" + nodes[askedAbout].name + "' erfahren. Welchem Bereich lassen sich die Informationen über Praxisbeispiele, Maßnahmen oder Strategien, die Sie von '" + nodes[askedAbout].name + "' erhalten haben, hauptsächlich zuordnen?")
			  .call(wrap2, backdrop_width - 20);
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			if (schulentwicklungForm[0].checked) {
				nodes1[askedAbout].q3 = "Unterrichtsentwicklung zu Themen der BNE";
            } else if (schulentwicklungForm[1].checked) {
                nodes1[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes1[askedAbout].q3 = "Organisatorische Bedingungen";
            } else if (schulentwicklungForm[3].checked) {
                nodes1[askedAbout].q3 = "Kommunikation (Öffentlichkeitsarbeiten, Elternarbeit, Schülerpartizipation)";
            } else if (schulentwicklungForm[4].checked) {
                nodes1[askedAbout].q3 = "Gesamtstrategien BNE (z.B.  Schulprogramm, ganzheitliche Schulentwicklung für BNE)";
            //} else if (schulentwicklungForm[5].checked) {
                //nodes1[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}
	...
	// If user has not selected an option, alert with popup
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p1_q4_n1_4 = nodes1[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p1_q4_n1_5 = nodes1[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p1_q4_n1_6 = nodes1[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p1_q4_n1_7 = nodes1[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p1_q4_n1_8= nodes1[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p1_q4_n1_9 = nodes1[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p1_q4_n1_10 = nodes1[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p1_q4_n1_11 = nodes1[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
             if (funktionenForm[0].checked) {
               ...
               p1_q4_n2_4 = nodes1[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p1_q4_n2_5 = nodes1[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p1_q4_n2_6 = nodes1[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p1_q4_n2_7 = nodes1[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p1_q4_n2_8= nodes1[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p1_q4_n2_9 = nodes1[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p1_q4_n2_10 = nodes1[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p1_q4_n2_11 = nodes1[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p1_q4_n3_4 = nodes1[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p1_q4_n3_5 = nodes1[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p1_q4_n3_6 = nodes1[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p1_q4_n3_7 = nodes1[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p1_q4_n3_8= nodes1[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p1_q4_n3_9 = nodes1[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p1_q4_n3_10 = nodes1[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p1_q4_n3_11 = nodes1[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
               ...
               p1_q4_n4_4 = nodes1[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p1_q4_n4_5 = nodes1[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p1_q4_n4_6 = nodes1[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p1_q4_n4_7 = nodes1[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p1_q4_n4_8= nodes1[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p1_q4_n4_9 = nodes1[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p1_q4_n4_10 = nodes1[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p1_q4_n4_11 = nodes1[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") &&!checked && !skipped) {
			...
			//collect Data
               ...
               p1_q4_n5_4 = nodes1[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p1_q4_n5_5 = nodes1[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p1_q4_n5_6 = nodes1[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p1_q4_n5_7 = nodes1[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p1_q4_n5_8= nodes1[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p1_q4_n5_9 = nodes1[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p1_q4_n5_10 = nodes1[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p1_q4_n5_11 = nodes1[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
			...
			d3.select("svg").append("text")
			  ...
			  .attr("x", currNode.x - q_window_width / 2 - 100)
			  .attr("dy", currNode.y - 202)
			  .text("Wir würden gerne mehr über '" + nodes[askedAbout].name + "' erfahren. Haben Sie das Gefühl, viel von '"+ nodes[askedAbout].name +"' in Bezug auf  Bildung für nachhaltige Entwicklung lernen zu können?" )
			  .call(wrap2, backdrop_width - 20);
...
//---------------------------2. Part-------------------------------------------------------
		...
		resetGraph();
			...
			document.getElementById("name_input").style.display = "block";
			document.getElementById("name_input").style.left = string_l + "px";
			document.getElementById("one_at_a_time1").style.display = "block";
			document.getElementById("erläuterungen1").style.display = "block";
            ...
            nodes.forEach(function(n) {
			  ...
			  if (n.index > 0) {
				if (n.x < boxbar_offset_x + bar6_target_width && n.y < (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*2) && n.y > (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*3)) {
                  ...
                  p2_dd1[i] = n.dd1 = "Ministerien";
                } else if (n.x < boxbar_offset_x + bar6_target_width * 2 + boxbar_margin && n.y > boxbar_offset_y){
                  p2_dd1[i] = n.dd1 = "Schulträger";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2 + bar6_target_width && n.y > boxbar_offset_y){
                  p2_dd1[i] = n.dd1 = "Außerschulische Bildungsanbieter";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 3 + bar6_target_width && n.y > boxbar_offset_y){
                  p2_dd1[i] = n.dd1 = "Universität";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 4 + bar6_target_width && n.y > boxbar_offset_y){
		...
		if ((erhInfoInput.value === null || erhInfoInput.value === "") && !checked && !skipped) {
			...
			d3.select("svg").append("text")
			  ...
			  .attr("x", currNode.x - q_window_width / 2 - 100)
			  .attr("dy", currNode.y - 202)
			  .text("Wir würden gerne mehr über Ihren Austausch mit '" + nodes[askedAbout].name + "' erfahren. Welchem Bereich lassen sich die Informationen über Praxisbeispiele, Maßnahmen oder Strategien, die Sie an '" + nodes[askedAbout].name + "' weitergegeben haben, hauptsächlich zuordnen?")
			  .call(wrap2, backdrop_width - 20);
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes2[askedAbout].q3 = "Unterrichtsentwicklung zu Themen der BNE";
            } else if (schulentwicklungForm[1].checked) {
                nodes2[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes2[askedAbout].q3 = "Organisatorische Bedingungen";
            } else if (schulentwicklungForm[3].checked) {
                nodes2[askedAbout].q3 = "Kommunikation (Öffentlichkeitsarbeiten, Elternarbeit, Schülerpartizipation)";
            } else if (schulentwicklungForm[4].checked) {
                nodes2[askedAbout].q3 = "Gesamtstrategien BNE (z.B. Schulprogramm, ganzheitliche Schulentwicklung für BNE)";
            //} else if (schulentwicklungForm[5].checked) {
                //nodes1[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}	
	...
	// If user has not selected an option, alert with popup
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p2_q4_n1_4 = nodes2[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p2_q4_n1_5 = nodes2[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p2_q4_n1_6 = nodes2[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p2_q4_n1_7 = nodes2[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p2_q4_n1_8= nodes2[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p2_q4_n1_9 = nodes2[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p2_q4_n1_10 = nodes2[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p2_q4_n1_11 = nodes2[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
             if (funktionenForm[0].checked) {
               ...
               p2_q4_n2_4 = nodes2[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p2_q4_n2_5 = nodes2[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p2_q4_n2_6 = nodes2[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p2_q4_n2_7 = nodes2[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p2_q4_n2_8= nodes2[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p2_q4_n2_9 = nodes2[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p2_q4_n2_10 = nodes2[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p2_q4_n2_11 = nodes2[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p2_q4_n3_4 = nodes2[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p2_q4_n3_5 = nodes2[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p2_q4_n3_6 = nodes2[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p2_q4_n3_7 = nodes2[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p2_q4_n3_8= nodes2[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p2_q4_n3_9 = nodes2[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p2_q4_n3_10 = nodes2[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p2_q4_n3_11 = nodes2[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p2_q4_n4_4 = nodes2[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p2_q4_n4_5 = nodes2[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p2_q4_n4_6 = nodes2[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p2_q4_n4_7 = nodes2[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p2_q4_n4_8= nodes2[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p2_q4_n4_9 = nodes2[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p2_q4_n4_10 = nodes2[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p2_q4_n4_11 = nodes2[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked && !skipped) {
			...
			//collect Data
             if (funktionenForm[0].checked) {
               ...
               p2_q4_n5_4 = nodes2[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p2_q4_n5_5 = nodes2[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p2_q4_n5_6 = nodes2[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p2_q4_n5_7 = nodes2[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p2_q4_n5_8= nodes2[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p2_q4_n5_9 = nodes2[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p2_q4_n5_10 = nodes2[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p2_q4_n5_11 = nodes2[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=subjWahrLernm]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (lernmöglichkeitenForm[0].checked) {
				nodes2[askedAbout].q5 = "ja";
            } else if (lernmöglichkeitenForm[1].checked) {
                nodes2[askedAbout].q5 = "eher ja";
            } else if (lernmöglichkeitenForm[2].checked) {
                nodes2[askedAbout].q5 = "eher nein";
            } else if (lernmöglichkeitenForm[3].checked) {
                nodes2[askedAbout].q5 = "nein";
            }
...
//---------------------------3. Part-------------------------------------------------------
		...
		// 3. name input field
			...
			document.getElementById("name_input").style.display = "block";
			document.getElementById("name_input").style.left = string_l + "px";
			document.getElementById("one_at_a_time2").style.display = "block";
			document.getElementById("erläuterungen2").style.display = "block";
            ...
            nodes.forEach(function(n) {
			  ...
			  if (n.index > 0) {
				if (n.x < boxbar_offset_x + bar6_target_width && n.y < (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*2) && n.y > (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*3)) {
                  ...
                  p3_dd1[i] = n.dd1 = "Ministerien";
                } else if (n.x < boxbar_offset_x + bar6_target_width * 2 + boxbar_margin && n.y > boxbar_offset_y){
                  p3_dd1[i] = n.dd1 = "Schulträger";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2 + bar6_target_width && n.y > boxbar_offset_y){
                  p3_dd1[i] = n.dd1 = "Außerschulische Bildungsanbieter";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 3 + bar6_target_width && n.y > boxbar_offset_y){
                  p3_dd1[i] = n.dd1 = "Universität";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 4 + bar6_target_width && n.y > boxbar_offset_y){
...
// If user has not selected an option, alert with popup
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes3[askedAbout].q3 = "Unterrichtsentwicklung zu Themen der BNE";
            } else if (schulentwicklungForm[1].checked) {
                nodes3[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes3[askedAbout].q3 = "Organisatorische Bedingungen";
            } else if (schulentwicklungForm[3].checked) {
                nodes3[askedAbout].q3 = "Kommunikation (Öffentlichkeitsarbeiten, Elternarbeit, Schülerpartizipation)";
            } else if (schulentwicklungForm[4].checked) {
                nodes3[askedAbout].q3 = "Gesamtstrategien BNE (z.B. Schulprogramm, ganzheitliche Schulentwicklung für BNE)";
            //} else if (schulentwicklungForm[5].checked) {
                //nodes1[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}	
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p3_q4_n1_4 = nodes3[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p3_q4_n1_5 = nodes3[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p3_q4_n1_6 = nodes3[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p3_q4_n1_7 = nodes3[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p3_q4_n1_8= nodes3[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p3_q4_n1_9 = nodes3[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p3_q4_n1_10 = nodes3[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p3_q4_n1_11 = nodes3[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p3_q4_n2_4 = nodes3[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p3_q4_n2_5 = nodes3[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p3_q4_n2_6 = nodes3[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p3_q4_n2_7 = nodes3[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p3_q4_n2_8= nodes3[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p3_q4_n2_9 = nodes3[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p3_q4_n2_10 = nodes3[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p3_q4_n2_11 = nodes3[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
               ...
               p3_q4_n3_4 = nodes3[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p3_q4_n3_5 = nodes3[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p3_q4_n3_6 = nodes3[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p3_q4_n3_7 = nodes3[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p3_q4_n3_8= nodes3[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p3_q4_n3_9 = nodes3[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p3_q4_n3_10 = nodes3[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p3_q4_n3_11 = nodes3[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
             if (funktionenForm[0].checked) {
               ...
               p3_q4_n4_4 = nodes3[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p3_q4_n4_5 = nodes3[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p3_q4_n4_6 = nodes3[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p3_q4_n4_7 = nodes3[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p3_q4_n4_8= nodes3[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p3_q4_n4_9 = nodes3[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p3_q4_n4_10 = nodes3[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p3_q4_n4_11 = nodes3[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked && !skipped) {
			...
			//collect Data
             if (funktionenForm[0].checked) {
               ...
               p3_q4_n5_4 = nodes3[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p3_q4_n5_5 = nodes3[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p3_q4_n5_6 = nodes3[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p3_q4_n5_7 = nodes3[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p3_q4_n5_8= nodes3[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p3_q4_n5_9 = nodes3[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p3_q4_n5_10 = nodes3[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p3_q4_n5_11 = nodes3[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=subjWahrLernm]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (lernmöglichkeitenForm[0].checked) {
				nodes3[askedAbout].q5 = "ja";
            } else if (lernmöglichkeitenForm[1].checked) {
                nodes3[askedAbout].q5 = "eher ja";
            } else if (lernmöglichkeitenForm[2].checked) {
                nodes3[askedAbout].q5 = "eher nein";
            } else if (lernmöglichkeitenForm[3].checked) {
                nodes3[askedAbout].q5 = "nein";
            }
		...
		if ($('input[name=rahmenDerInfoweitergabe2]:checked').length == 0 && !checked) {
			...
			//Collect Data
              if (rahmenbedingungenForm2[0].checked) {
               p3_q7_1 = nodes[0].q7_1 = "geschieht auf regelmäßiger Basis";
              } if (rahmenbedingungenForm2[1].checked) {
               p3_q7_2= nodes[0].q7_2 = "es gibt dafür eigens vorgesehene Arbeitszeiten/Treffen (außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)";
              } if (rahmenbedingungenForm2[2].checked) {
               p3_q7_3 = nodes[0].q7_3 = "es werden bestimmte Methoden und Formate genutzt";
              } if (rahmenbedingungenForm2[3].checked) {
               p3_q7_4 = nodes[0].q7_4 = "geschieht im Rahmen der Netzwerktreffen oder Veranstaltungen des Netzwerks";
              }	if (rahmenbedingungenForm2[4].checked) {
               p3_q7_5 = nodes[0].q7_5 = "geschieht ausschließlich aus Eigeninitiative der beteiligten Personen";
              }	if (rahmenbedingungenForm2[5].checked) {
               p3_q7_6 = nodes[0].q7_6 = "wird von der Schulleitung gefördert";
              }	if (rahmenbedingungenForm2[6].checked) {
               p3_q7_7 = nodes[0].q7_7 = "wird von der Schulleitung angeordnet";
              }
...
//---------------------------4. Part-------------------------------------------------------	
		  ...
		  document.getElementById("slide52").style.display ="none";
			...
			document.getElementById("name_input").style.display = "block";
			document.getElementById("name_input").style.left = string_l + "px";
			document.getElementById("one_at_a_time3").style.display = "block";
			document.getElementById("erläuterungen3").style.display = "block";
            ...
            nodes.forEach(function(n) {
			  ...
			  if (n.index > 0) {
				if (n.x < boxbar_offset_x + bar6_target_width && n.y < (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*2) && n.y > (boxbar_offset_y - bar_label_height*3 - boxbar_label_margin*3 - boxbar_margin*3 - bar_target_height*3)) {
                  ...
                  p4_dd1[i] = n.dd1 = "Ministerien";
                } else if (n.x < boxbar_offset_x + bar6_target_width * 2 + boxbar_margin && n.y > boxbar_offset_y){
                  p4_dd1[i] = n.dd1 = "Schulträger";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 2 + bar6_target_width && n.y > boxbar_offset_y){
                  p4_dd1[i] = n.dd1 = "Außerschulische Bildungsanbieter";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 3 + bar6_target_width && n.y > boxbar_offset_y){
                  p4_dd1[i] = n.dd1 = "Universität";
				} else if (n.x < boxbar_offset_x + (bar6_target_width + boxbar_margin) * 4 + bar6_target_width && n.y > boxbar_offset_y){
		...
		if ($('input[name=artDerKommunikation]:checked').length == 0 && !checked && !skipped) {
			...
			d3.select("svg").append("text")
			  ...
			  .attr("x", currNode.x - q_window_width / 2 - 100)
			  .attr("dy", currNode.y - 202)
			  .text("Wir würden gerne mehr über Ihre gemeinsame Entwicklung mit '" + nodes[askedAbout].name + "' erfahren. Bitte beschreiben Sie in einigen Stichworten, zu welchem Thema Sie mit '" + nodes[askedAbout].name + "' Strategien oder Maßnahmen entwickelt haben.")
			  .call(wrap2, backdrop_width - 20);
		...
		if ((erhInfoInput.value === null || erhInfoInput.value === "") && !checked && !skipped) {
			...
			d3.select("svg").append("text")
			  ...
			  .attr("x", currNode.x - q_window_width / 2 - 100)
			  .attr("dy", currNode.y - 202)
			  .text("Wir würden gerne mehr über Ihre gemeinsame Entwicklung mit '" + nodes[askedAbout].name + "' erfahren. Welchem Bereich lassen sich die Maßnahmen oder Strategien, die Sie mit '" + nodes[askedAbout].name + "' entwickelt haben, hauptsächlich zuordnen?")
			  .call(wrap2, backdrop_width - 20);
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes4[askedAbout].q3 = "Unterrichtsentwicklung zu Themen der BNE";
            } else if (schulentwicklungForm[1].checked) {
                nodes4[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes4[askedAbout].q3 = "Organisatorische Bedingungen";
            } else if (schulentwicklungForm[3].checked) {
                nodes4[askedAbout].q3 = "Kommunikation (Öffentlichkeitsarbeiten, Elternarbeit, Schülerpartizipation)";
            } else if (schulentwicklungForm[4].checked) {
                nodes4[askedAbout].q3 = "Gesamtstrategien BNE (z.B. Schulprogramm, ganzheitliche Schulentwicklung für BNE)";
            //} else if (schulentwicklungForm[5].checked) {
                //nodes4[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}	
	...
	// If user has not selected an option, alert with popup
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p4_q4_n1_4 = nodes4[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p4_q4_n1_5 = nodes4[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p4_q4_n1_6 = nodes4[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p4_q4_n1_7 = nodes4[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p4_q4_n1_8= nodes4[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p4_q4_n1_9 = nodes4[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p4_q4_n1_10 = nodes4[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p4_q4_n1_11 = nodes4[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p4_q4_n2_4 = nodes4[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p4_q4_n2_5 = nodes4[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p4_q4_n2_6 = nodes4[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p4_q4_n2_7 = nodes4[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p4_q4_n2_8= nodes4[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p4_q4_n2_9 = nodes4[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p4_q4_n2_10 = nodes4[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p4_q4_n2_11 = nodes4[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p4_q4_n3_4 = nodes4[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p4_q4_n3_5 = nodes4[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p4_q4_n3_6 = nodes4[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p4_q4_n3_7 = nodes4[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p4_q4_n3_8= nodes4[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p4_q4_n3_9 = nodes4[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p4_q4_n3_10 = nodes4[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p4_q4_n3_11 = nodes4[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p4_q4_n4_4 = nodes4[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p4_q4_n4_5 = nodes4[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p4_q4_n4_6 = nodes4[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p4_q4_n4_7 = nodes4[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p4_q4_n4_8= nodes4[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p4_q4_n4_9 = nodes4[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p4_q4_n4_10 = nodes4[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p4_q4_n4_11 = nodes4[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=funktionenDerPersonen]:checked').length == 0 && (inputFunktionen.value === null || inputFunktionen.value === "") && !checked && !skipped) {
			...
			//collect Data
              if (funktionenForm[0].checked) {
               ...
               p4_q4_n5_4 = nodes4[askedAbout].q4_4 = "Steuergruppe oder AG BNE-Konzept oder ähnliches";
              }	if (funktionenForm[4].checked) {
               p4_q4_n5_5 = nodes4[askedAbout].q4_5 = "Vorsitz der Fachkonferenz";
              }	if (funktionenForm[5].checked) {
               p4_q4_n5_6 = nodes4[askedAbout].q4_6 = "Mitglied der Schulkonferenz";
              }	if (funktionenForm[6].checked) {
               p4_q4_n5_7 = nodes4[askedAbout].q4_7 = "Fortbildungsbeauftragte*r";
              }if (funktionenForm[7].checked) {
               p4_q4_n5_8= nodes4[askedAbout].q4_8 = "Mitglied des Lehrrates";
              } if (funktionenForm[8].checked) {
               p4_q4_n5_9 = nodes4[askedAbout].q4_9 = "Schülervertretung";
              } if (funktionenForm[9].checked) {
               p4_q4_n5_10 = nodes4[askedAbout].q4_10 = "Klimadetektiv oder ähnliches";
              }	if (funktionenForm[10].checked) {
               p4_q4_n5_11 = nodes4[askedAbout].q4_11 = "Nicht-schulisch (z.B. Ministerien, Schulträger, außerschulischer Bildungsanbieter, Universität)";
              }	if (funktionenForm[11].checked) {
		...
		if ($('input[name=subjWahrLernm]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (lernmöglichkeitenForm[0].checked) {
				nodes4[askedAbout].q5 = "ja";
            } else if (lernmöglichkeitenForm[1].checked) {
                nodes4[askedAbout].q5 = "eher ja";
            } else if (lernmöglichkeitenForm[2].checked) {
                nodes4[askedAbout].q5 = "eher nein";
            } else if (lernmöglichkeitenForm[3].checked) {
                nodes4[askedAbout].q5 = "nein";
            }
		...
		if ($('input[name=rahmenDerInfoweitergabe3]:checked').length == 0 && !checked) {
			...
			//Collect Data
              if (rahmenbedingungenForm3[0].checked) {
               p4_q7_1 = nodes[0].q7_1 = "geschieht auf regelmäßiger Basis";
              } if (rahmenbedingungenForm3[1].checked) {
               p4_q7_2= nodes[0].q7_2 = "es gibt dafür vorgesehene Arbeitszeiten/Treffen (außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)";
              } if (rahmenbedingungenForm3[2].checked) {
               p4_q7_3 = nodes[0].q7_3 = "es werden bestimmte Methoden und Formate genutzt";
              } if (rahmenbedingungenForm3[3].checked) {
               p4_q7_4 = nodes[0].q7_4 = "geschieht im Rahmen der Netzwerktreffen oder Veranstaltungen des Netzwerks";
              }	if (rahmenbedingungenForm3[4].checked) {
               p4_q7_5 = nodes[0].q7_5 = "geschieht ausschließlich aus Eigeninitiative der beteiligten Personen";
              }	if (rahmenbedingungenForm3[5].checked) {
               p4_q7_6 = nodes[0].q7_6 = "wird von der Schulleitung gefördert";
              }	if (rahmenbedingungenForm3[6].checked) {
               p4_q7_7 = nodes[0].q7_7 = "wird von der Schulleitung angeordnet";
              } 
		...
		// If user has not selected an option, alert with popup
		 /* if (($('input[name=bnegpos]:checked').length == 0 || $('input[name=bvrivij]:checked').length == 0 || $('input[name=bwanver]:checked').length == 0) && !checked) {
            ...
            */
			...
			//set array to actual number of questions
	...
	<div class="input-group no-wrap" display="none" id="digiSchulentwicklung" method="get">
	  <form id="digitaleSchulentwicklung" display="none">
		<input type="radio" name="digitaleSchulentwicklung" value="1"><span class="questionText"> Unterrichtsentwicklung zu Themen der BNE</span><br>
		...
		<input type="radio" name="digitaleSchulentwicklung" value="3"><span class="questionText"> Organisatorische Bedingungen<br><span class="einrueckung">(Steuergruppen, Schulleitungshandeln,...)</span></span><br>
		<input type="radio" name="digitaleSchulentwicklung" value="4"><span class="questionText"> Kommunikation (Öffentlichkeitsarbeit, Elternarbeit, Schülerpartizipation,...)</span><br>
		<input type="radio" name="digitaleSchulentwicklung" value="5"><span class="questionText"> Gesamtstrategie BNE (z.B.  Schulprogramm, ganzheitliche <br><span class="einrueckung">Schulentwicklung für BNE,...)</span>		
	  </form>
    </div>
	...
	<div class="input-group no-wrap" display="none" id="funktionenPersonen" method="get">
	  <form id="funktionenDerPersonen" display="none">
		...
		<input type="checkbox" name="funktionenDerPersonen" value="4"><span class="questionText"> Steuergruppe oder AG "BNE-Konzept"<br><span class="einrueckung"> oder ähnliches</span></span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="5"><span class="questionText"> Vorsitz der Fachkonferenz</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="6"><span class="questionText"> Mitglied der Schulkonferenz</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="7"><span class="questionText"> Fortbildungsbeauftragte*r</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="8"><span class="questionText"> Mitglied des Lehrrates</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="9"><span class="questionText"> Schüler- oder Elternvertretung</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="10"><span class="questionText"> Klimadetektiv oder Ähnliches</span><br>
		<input type="checkbox" name="funktionenDerPersonen" value="11"><span class="questionText"> Nicht-schulisch (z.B. Ministerien,<br><span class="einrueckung">Schulträger, außerschulischer Bildungsanbieter, Universität)</span></span><br>
	...
	<div class="input-group" display="none" id="gradFormalisierung" method="get">
		<form id="gradDerFormalisierung" display="none">
			<span class="slideText">Wenn Sie daran denken, wie Sie in den letzten drei Monaten Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema Bildung für nachhaltige Entwicklung an <b>Personen an Ihrer Schule</b> weitergegeben haben: Was trifft auf die Rahmenbedingungen der Informationsweitergabe zu?</span><br><br>
	...
	<div class="input-group" display="none" id="gradFormalisierung2" method="get">
		<form id="gradDerFormalisierung2" display="none">
			<span class="slideText">Wenn Sie daran denken, wie Sie mit <b>Personen an Ihrer Schule</b> in den letzten drei Monaten arbeitsteilig an bestehenden oder neuen Strategien oder Maßnahmen zum Thema Bildung für nachhaltige Entwicklung zusammengearbeitet haben: Was trifft auf die Rahmenbedingungen der Zusammenarbeit zu?</span><br><br>
			<span class="slideText">(Mehrfachnennungen möglich):</span><br><br>
			<input type="checkbox" name="gradDerFormalisierung2" value="1"><span class="questionText"> geschieht auf regelmäßiger Basis</span><br>
			<input type="checkbox" name="gradDerFormalisierung2" value="2"><span class="questionText"> es gibt dafür eigens vorgesehene Arbeitszeiten/Treffen<br><span class="einrueckung">(außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)</span></span><br>
	...
	<div class="input-group" display="none" id="gradFormalisierung3" method="get">
		<form id="gradDerFormalisierung3" display="none">
			<span class="slideText">Wenn Sie daran denken, wie Sie mit <b>Personen an Ihrer Schule</b> in den letzten drei Monaten gemeinsam Strategien oder Maßnahmen zum Thema Bildung für nachhaltige Entwicklung an der Schule entwickelt haben: Was trifft auf die Rahmenbedingungen der gemeinsamen Entwicklung zu?</span><br><br>
			<span class="slideText">(Mehrfachnennungen möglich):</span><br><br>
			<input type="checkbox" name="gradDerFormalisierung3" value="1"><span class="questionText"> geschieht auf regelmäßiger Basis</span><br>
			<input type="checkbox" name="gradDerFormalisierung3" value="2"><span class="questionText"> es gibt dafür vorgesehene Arbeitszeiten/Treffen<br><span class="einrueckung">(außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)</span></span><br>
	...
	<div class="input-group" display="none" id="rahmenbedingungenInfoweitergabe1" method="get">
		<form id="rahmenDerInfoweitergabe1" display="none">
			<span class="slideText">Wenn Sie daran denken, wie Sie in den letzten drei Monaten Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema Bildung für nachhaltige Entwicklung an <b>Personen außerhalb Ihrer Schule</b> weitergegeben haben: Was trifft auf die Rahmenbedingungen der Informationsweitergabe zu?</span><br><br>
			<span class="slideText">(Mehrfachnennungen möglich):</span><br><br>
	...
	<div class="input-group" display="none" id="rahmenbedingungenInfoweitergabe2" method="get">
		<form id="rahmenDerInfoweitergabe2" display="none">
			...
			<input type="checkbox" name="rahmenDerInfoweitergabe2" value="2"><span class="questionText"> es gibt dafür eigens vorgesehene Arbeitszeiten/Treffen<br><span class="einrueckung">(außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)</span><br>
	...
	<div class="input-group" display="none" id="rahmenbedingungenInfoweitergabe3" method="get">
		<form id="rahmenDerInfoweitergabe3" display="none">
			<span class="slideText">Wenn Sie daran denken, wie Sie mit <b>Personen außerhalb Ihrer Schule</b> in den letzten drei Monaten gemeinsam Strategien oder Maßnahmen zum Thema Bildung für nachhaltige Entwicklung entwickelt haben: Was trifft auf die Rahmenbedingungen der gemeinsamen Entwicklung zu?</span><br><br>
			<span class="slideText">(Mehrfachnennungen möglich):</span><br><br>
			...
			<input type="checkbox" name="rahmenDerInfoweitergabe3" value="2"><span class="questionText"> es gibt dafür vorgesehene Arbeitszeiten/Treffen <br><span class="einrueckung">(außerhalb der ohnehin vorgegebenen Treffen wie z.B. Lehrerkonferenzen, Fachkonferenzen)</span></span><br>
	...
	<div class="popop_box" id="falseID_box">
      <div class="popup_box" id="falseIdPopup">
            <p class="popup_text">Bitte geben Sie nur Ihren individuellen Teilnehmercode ein, den Sie mit Ihrer Einladungsmail erhalten haben.</p>
            <button class="btn btn-default" onclick="closeFalseIDPopup()">Schließen</button>
      </div>
    </div>	

    <div class="popop_box" id="onlyone_box">
      <div class="popup_box" id="onlyOnePopup">
            <p class="popup_text">Bitte geben Sie jeweils nur die ersten beiden Buchstaben des Vor- und Nachnamens ein (Bsp.: Erika Musterfrau = ErMu).<br>Geben Sie bitte immer nur ein Kürzel ein.</p>
