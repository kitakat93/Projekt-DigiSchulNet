...
<html lang="de">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      var string_t = "100px";	//Original GENSI 200px
      var string_r_t = "45%",
          q_margin_top = 200,
...
//removes nodes and links and refreshes	with a single start-node ("Sie")	  
	...
	//Slide with name input field
      ...
      slide_3.append("text")
        ...
        .text("Wenn Sie an die letzten drei Monate denken, von welchen Personen haben Sie Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema Digitalisierung der Schule ")
        .call(wrap, textWidth);
      slide_3.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + textWidth/3 + 9)
      ...
      slide_7.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wir stellen Ihnen nun nacheinander Fragen zu jeder der von Ihnen genannten Personen.")	
        .call(wrap, textWidth)
	  slide_7.append("text")
        .attr("class", "slideText numfri")
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top + lineHeight * ($('#slide7 .slideText tspan').length + $('#slide7 .slideText').length-1))
        .text("Bitte beantworten Sie diese Fragen für jede Person. Bitte klicken Sie \"Weiter\" um fortzufahren.")	
        .call(wrap, textWidth);
    ...
    var slide_12 = d3.select("svg").append("g")
	  ...
	  slide_14.append("text")
          ...
          .attr("x", center - textWidth / 2)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 4-50)
          .text("Im Folgenden werden Ihnen nun einige Fragen dazu gestellt, an welche Personen an Ihrer Schule oder aus dem regionalen Schulnetzwerk Sie selbst in den letzten drei Monaten Informationen zur Digitalisierung in der schulischen Arbeit ")
          .call(wrap, textWidth);
	  slide_14.append("text")
		.attr("class", "underlinedSlideText")
		.text("weitergegeben")
	...
	var slide_15 = d3.select("svg").append("g")
      ...
      slide_15.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, an wen haben Sie Informationen über bestehende oder neue Praxisbeispiele, Maßnahmen oder Strategien zum Thema Digitalisierung der Schule ")
        .call(wrap, textWidth);
      slide_15.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + textWidth/4)
        .attr("y", text_offset_top + lineHeight)
        .text("weitergegeben?")
        .call(wrap, textWidth);		
      slide_15.append("text")
	...
	var slide_33 = d3.select("svg").append("g")
	 ...
	 slide_33.append("rect")
	  ...
	  slide_33.append("text")
          ...
          .attr("x", center - textWidth / 2)
          .attr("y", text_offset_top + title_offset_top + lineHeight * 4-50)
          .text("Im Folgenden werden Ihnen nun einige Fragen dazu gestellt, mit welchen Personen an Ihrer Schule oder aus dem regionalen Schulnetzwerk Sie in den letzten drei Monaten arbeitsteilig an Strategien oder Maßnahmen zur Digitalisierung in der Schule ")
          .call(wrap, textWidth);
	  slide_33.append("text")
          .attr("class", "underlinedSlideText")
          .attr("x", center - textWidth / 4)
	...
	var slide_34 = d3.select("svg").append("g")
      ...
      slide_34.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, mit welchen Personen haben Sie arbeitsteilig an bestehenden oder neuen Strategien oder Maßnahmen zur Digitalisierung an der Schule ")
        .call(wrap, textWidth);
      slide_34.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + (textWidth / 5) - 69)
        .attr("y", text_offset_top + lineHeight)
        .text("zusammengearbeitet?")
        .call(wrap, textWidth);
      slide_34.append("text")
	...
	var slide_50 = d3.select("svg").append("g")
	 ...
	 slide_52.append("rect")
      ...
      slide_53.append("text")
        ...
        .attr("x", center - (textWidth / 2))
        .attr("y", text_offset_top)
        .text("Wenn Sie an die letzten drei Monate denken, mit welchen Personen haben Sie sich getroffen, um gemeinsam systematisch Strategien oder Maßnahmen zur Digitalisierung an der Schule zu ")
        .call(wrap, textWidth);
      slide_53.append("text")
        .attr("class", "underlinedSlideText")
        .attr("x", center + (textWidth / 5))
      ...
      slide_53.append("text")
        ...
        .style("stroke", "none")
        .style("fill", "red")
        .text("Gibt es weitere Personen, mit denen Sie sich getroffen haben, um gemeinsam Strategien oder Maßnahmen zur Digitalisierung an der Schule zu entwickeln? Bitte geben Sie die Abkürzung der Namen ein. Falls nicht zutreffend, klicken Sie bitte weiter.")
        .call(wrap, textWidth)
        .attr("display", "none");
      slide_53.append("text")
        .attr("class", "slideText")
	...
	var slide_71 = d3.select("svg").append("g")
	  ...
	  slide_71.append("text")
          ...
          .text("Bitte klicken Sie auf 'Senden' um Ihre Eingabe zu übermitteln. Anschließend können Sie das Fenster schließen.") 
          .call(wrap, textWidth);
	  slide_71.style("display", "none");
	
	  
	//----------------------------------------------------------------------------------        
	// Boxes indicating frequency into which nodes are dragged (4, 5, 6 or 10 categories)
	//----------------------------------------------------------------------------------
   ...
   var sixLabelBar1 = d3.select("svg").append("g")
     ...
     sixLabelBar1.append("rect")
      ...
      sixLabelBar1.append("text")
        .attr("class", "bar_text")
        .text("Gar Nicht")
        .attr("x", boxbar_offset_x + (bar6_target_width / 2) - 40) 
...
//labels and texts for tenBar 1
   var eightLabelBar1 = d3.select("svg").append("g")
      ...
      eightLabelBar1.append("text")
        .attr("class", "bar_text")
        .text("Schüler*in")
        .attr("x", boxbar_offset_x + (bar6_target_width / 2) - 30) 
      ...
      function addFriend() {
        ...
        if (friendName.value.length > 4 || friendName.value.indexOf(' ') != -1|| friendName.value.search(/^[a-zA-ZüÜöÖäÄß ]+$/)== -1) {
		  ...
		  //note: final friend texts actually disabled
		  document.getElementById("final_friend_text").style.display = "none";
      ...
      function removeLink(l) {
		...
		//note: Slide has to be set to a higher value than the CurrSlide of the question itself, otherwise lines cannot be drawn (on slide 13).
        if (currSlide == 14) {
        ...
        if (currSlide == 14) {
          ...
          if (selected == false) {
            ...
            if (targetId != sourceId) {
			  ...
			  //handles "friends with" relationships or "links" 
	  ...
	  function showNext() {
        if (currSlide == 0){
		 ...
		 promptNoId();
		  ...
		  //after getElementById("next") the previous page is hidden and the new page is displayed, page number is incremented
...
//	Slides with tenBar
		  ...
		  nodes.forEach(function(n) {
			...
			//actual statement for ten Boxes   
              if (((n.x > boxbar_offset_x + bar6_target_width) && (n.x < (boxbar_offset_x + (bar6_target_width + boxbar_margin) * 5)) && (n.y < boxbar_offset_y)) || (n.y < (boxbar_offset_y - 450)) || (n.y < (boxbar_offset_y - bar_label_height - boxbar_label_margin - 150) && n.x >(boxbar_offset_x + (bar6_target_width + boxbar_margin) * 5))){
                nodeAbove = true;
                console.log("nodeAbove: " + nodeAbove);
              }
          ...
          if ((nodeBelow || nodeAbove) && !checked) {
            ...
            nodes.forEach(function(n) {
			  ...
			  if (n.index > 0) {
                ...
                } else if (n.x < (boxbar_offset_x + (bar6_target_width + boxbar_margin) * 5 + bar6_target_width)&& n.x >(boxbar_offset_x + (bar6_target_width + boxbar_margin) * 5) && n.y < (boxbar_offset_y - bar_label_height - boxbar_label_margin) && n.y > (boxbar_offset_y - bar_label_height - boxbar_label_margin - 150)) {
...
//----------------------actual version-----------------------------------------------
		...
		if ($('input[name=artDerKommunikation]:checked').length == 0 && !checked && !skipped) {
			...
			askedAbout = 0;				//set 0 to use the skip function
			askedAbout++;
			d3.selectAll(".node").attr("opacity", function(d) { return d.index == askedAbout ? 1 : .4 });
			currNode = nodes[askedAbout];
...
// If user has not selected an option, alert with popup
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			if (schulentwicklungForm[0].checked) {
				nodes1[askedAbout].q3 = "Technische Ausstattung der Schule";
                ...
                nodes1[askedAbout].q3 = "Unterrichtsentwicklung mit digitalen Medien";
...
//-----------------------------------------------------------		  
//Slide for relationships between persons and links
//----------------------------------------------------------	
...
//---------------------------2. Part-------------------------------------------------------
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes2[askedAbout].q3 = "Technische Ausstattung der Schule";
            } else if (schulentwicklungForm[1].checked) {
                nodes2[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes2[askedAbout].q3 = "Unterrichtsentwicklung mit digitalen Medien";
            } else if (schulentwicklungForm[3].checked) {
                ...
                nodes2[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}		
...
// If user has not selected an option, alert with popup
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes3[askedAbout].q3 = "Technische Ausstattung der Schule";
            } else if (schulentwicklungForm[1].checked) {
                nodes3[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes3[askedAbout].q3 = "Unterrichtsentwicklung mit digitalen Medien";
            } else if (schulentwicklungForm[3].checked) {
                ...
                nodes3[askedAbout].q3 = "Gesamtstrategien Digitalisierung (z.B. Medienkonzept)";
			}		
...
//---------------------------4. Part-------------------------------------------------------	
		...
		if ($('input[name=digitaleSchulentwicklung]:checked').length == 0 && !checked) {
			...
			//collect Data
			if (schulentwicklungForm[0].checked) {
				nodes4[askedAbout].q3 = "Technische Ausstattung der Schule";
            } else if (schulentwicklungForm[1].checked) {
                nodes4[askedAbout].q3 = "Fortbildungen/ Schulungen für Lehrkräfte";
            } else if (schulentwicklungForm[2].checked) {
                nodes4[askedAbout].q3 = "Unterrichtsentwicklung mit digitalen Medien";
            } else if (schulentwicklungForm[3].checked) {
	...
	<div class="input-group no-wrap" display="none" id="funktionenPersonen" method="get">
	  <form id="funktionenDerPersonen" display="none">
		...
		<input type="checkbox" name="funktionenDerPersonen" value="10"><span class="questionText"> Schülervertretung (inkl. Medienscouts) oder Elternvertretung</span><br>
